    ...
    <div class="d2030-modal-content">
      ...
      <div class="d2030-resource-grid">
        <div class="d2030-resource-group">
          <p class="d2030-resource-group-title">Videos</p>
          <div class="d2030-preview-list">
            ...
            <?php else : ?>
              <span class="d2030-btn-disabled">Video 1 coming soon</span>
            <?php endif; ?>
            ...
            <?php else : ?>
              <span class="d2030-btn-disabled">Video 2 coming soon</span>
            <?php endif; ?>
          </div>
        </div>
        <div class="d2030-resource-group">
          <p class="d2030-resource-group-title">Podcasts</p>
          <div class="d2030-preview-list">
            <?php if ( ! empty( $d2030_podcast_1_url ) ) : ?>
              <div class="d2030-preview-card">
                ...
                <div class="d2030-preview-actions">
                  <a href="<?php echo esc_url( $d2030_podcast_1_url ); ?>" class="d2030-btn-secondary" target="_blank" rel="noopener noreferrer">♪ Listen</a>
                </div>
              </div>
            <?php else : ?>
              <span class="d2030-btn-disabled">Podcast 1 coming soon</span>
            <?php endif; ?>
            <?php if ( ! empty( $d2030_podcast_2_url ) ) : ?>
              <div class="d2030-preview-card">
                ...
                <div class="d2030-preview-actions">
                  <a href="<?php echo esc_url( $d2030_podcast_2_url ); ?>" class="d2030-btn-secondary" target="_blank" rel="noopener noreferrer">♪ Listen</a>
                </div>
              </div>
            <?php else : ?>
              <span class="d2030-btn-disabled">Podcast 2 coming soon</span>
            <?php endif; ?>
            <div class="d2030-preview-card">
              <p class="d2030-preview-title">Script PDF</p>
              <div class="d2030-preview-actions">
                <?php if ( ! empty( $d2030_script_pdf_url ) ) : ?>
                  <a href="<?php echo esc_url( $d2030_script_pdf_url ); ?>" class="d2030-btn-secondary" target="_blank" rel="noopener noreferrer">⬇ Download Script PDF</a>
                <?php else : ?>
                  <span class="d2030-btn-disabled">Script PDF coming soon</span>
                <?php endif; ?>
              </div>
            </div>
          </div>
