<?php
/**
 * Template Name: Teach Our Children
 */
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="banner" id="video">
          ...
          <div class="video-grid">
            ...
            <div class="thumbs" aria-label="Video thumbnail gallery">
              ...
              <div style="margin-top:12px" aria-label="Podcast player">
                <h4 style="margin:0 0 10px; font-size:14px; color: rgba(255,255,255,0.86)">Toppling Dictators With Nylon And String</h4>
                <p style="margin:0 0 10px; color: var(--muted); font-size:13px">Listen to the podcast on kite festivals for peace.</p>
                <audio controls preload="metadata" style="width:100%; border-radius:14px; outline:none; background:#0a0f1f; border:1px solid rgba(234,240,255,.10)">
