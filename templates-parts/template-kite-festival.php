    ...
    <section id="media" class="media anchor" aria-label="Podcast and Video">
      <div class="panel">
        ...
        <audio controls preload="metadata">
          <source src="<?php echo esc_url( 'https://humanblockchain.info/wp-content/uploads/2026/02/Toppling_Dictators_With_Nylon_And_String.mp3' ); ?>" type="audio/mpeg" />
      ...
      <div class="panel">
        ...
        <video controls preload="metadata">
          <source src="<?php echo esc_url( 'https://humanblockchain.info/wp-content/uploads/2026/02/The_God_Wink_Proposal.mp4' ); ?>" type="video/mp4" />
