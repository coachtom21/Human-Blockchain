 ...
 <main class="wrap">
   <section class="card">
     <div class="card-inner">
       <div class="badge"><span class="dot"></span> Decentralized • Device-driven • Human-first</div>
 
       <h2>Join the DAO</h2>
       <p class="muted">
         Joining the DAO means participating in a <b>human-governed, device-driven network</b>
         where verification replaces trust assumptions and people—not platforms—form the ledger.
       </p>
       ...
       <div class="grid">
         ...
         <aside class="cta">
           ...
           <a class="btn btnPrimary" href="activate-device">
             <div>
           ...
           <a class="btn btnGhost" href="pod-mode">
             <div>
               Go to PoD Mode
